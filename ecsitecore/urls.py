...
urlpatterns = [
    ...
    path('list/<slug:slug>/', views.commodityDetailView.as_view(), name='commodity-detail'),
    path('list-update/<slug:slug>/', views.commodityUpdateView.as_view(), name='ecsite-update'),
